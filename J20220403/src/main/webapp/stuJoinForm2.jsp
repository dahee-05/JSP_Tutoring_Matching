			...
			<main>
				<form action="stuJoinPro2.do">
					<div class="condition1">
						<div id="parent">
							<h3 class="main-h1">■ 필수 회원 정보 입력</h3>
							<br> <input type="hidden" name="stu_id2" value="${stu_id2}">
							<input type="hidden" name="n_password" value="${n_password}">
							...
							<input class="input_birth" type="text" name="birth"
								required="required" placeholder="ex_19990130" title="8자리로 입력하세요">
							<p>
								<br>
							<div class="child c1">전화번호</div>
							<input class="input_ph" type="text" name="phone"
								required="required" placeholder="'-'를 제외하고 입력" pattern="\d{11}">
...
본 약관은 2022. 04. 29. 부터 적용합니다.
							...
							<div class="checkbox">
								<input type="checkbox" id="checkbox" name="checkbox1" required="required"> 약관을 충분히 이해하였으며 이에 동의합니다
							</div>
							<br>
							...
							<div class="checkbox">
								<input type="checkbox" id="checkbox" name="checkbox2" required="required"> 개인정보 수집 및 이용(필수)에 대한 안내를 이해하였으며 동의합니다.
							</div>
