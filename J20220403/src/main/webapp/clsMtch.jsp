				...
				<section class="section_com">
					<main>
						...
						<div id="container">
							<div id="content_header">
								...
								<div id="intro">
									...
									<div>
										...
										<br>
									<div>
										<c:if test="${classe.grade == 0 }">
											<h3>모든 학년</h3>		
										</c:if>
										
										<c:if test="${classe.grade != 0 }">
											<h3>${classe.grade }학년</h3>	
										</c:if>
									</div>
									<br>
									<br>
									...
									<div style="padding-left: 150px;">
								 		<button id="btn" onclick="resume()">이력서 보기</button>
										<c:choose>
							...
							<div id="move_bar">
								<ul class="clearfix">
									<li><a href="#loc">수업 가능한 지역</a></li>
									<li><a href="#time">수업 시간 & 기간</a></li>
									<li><a href="#t_intro">강사 소개</a></li>
									<li><a href="#l_intro">강의 소개</a></li>
							...
							<cot>
								...
								<div id="time" class="contents">
									<h2>수업 가능한 시간 & 기간</h2>
									<br>
									<br>
									<p>${classe.lec_time }</p>
									<br>
									<p>${classe.lec_duration }</p>
								</div>
								
								<div id="t_intro" class="contents">
									<h2>강사소개</h2>
										<br>
										<br>
									<pre id="curri">${classe.teacher_intro }</pre>
								</div>
								
								<div id="l_intro" class="contents">
									<h2>강의소개</h2>
										<br>
										<br>
									<pre id="curri">${classe.lec_intro }</pre>
								</div>
								
								<div id="curriculum" class="contents">
									<h2>커리큘럼</h2>
										<br>
										<br>
									<pre id="curri">${classe.curriculum }</pre>
								</div>	
							</cot>
						</div>
					</main>
