			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item" <c:if test="${menu_num == '1' }">style="border-right:5px solid #3B82F6"</c:if>>
						<a href="tchList.do" <c:if test="${menu_num == '1' }">style="background-color:#E3E9FE;color:#4487F6;font-weight:bold;"</c:if>
						class="menu-link" > 
					...
					<li class="menu-item">
						...
						<ul class="menu-sub" <c:if test="${menu_num == '3' || menu_num == '4' || menu_num == '5'}">style="display:block"</c:if>>
							<li class="menu-item" <c:if test="${menu_num == '3'}">style="border-right:5px solid #3B82F6"</c:if>>
								<a href="tchUpdateForm.do" <c:if test="${menu_num == '3' }">style="background-color:#E3E9FE;color:#4487F6;font-weight:bold;"</c:if>
								class="menu-link">개인정보 수정</a>
							</li>
							<li class="menu-item" <c:if test="${menu_num == '4'}">style="border-right:5px solid #3B82F6"</c:if>>
								<a href="tchPwChangeForm.do" <c:if test="${menu_num == '4' }">style="background-color:#E3E9FE;color:#4487F6;font-weight:bold;"</c:if>
								class="menu-link">비밀번호 변경</a>
							</li>
							<li class="menu-item" <c:if test="${menu_num == '5'}">style="border-right:5px solid #3B82F6"</c:if>>
								<a href="tchDeleteForm.do" <c:if test="${menu_num == '5' }">style="background-color:#E3E9FE;color:#4487F6;font-weight:bold;"</c:if>
								class="menu-link">회원탈퇴</a>
							</li>
						</ul></li>
				</ul>
				<div class="text-center mb-4">
					<p style="color:#4487F6">${tchName} 님</p>
