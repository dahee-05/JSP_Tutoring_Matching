...
public class TeacherDao {
	...
	public int check(String tch_id, String password) throws SQLException {
		...
		int result = 0;
		String sql = "select password from teacher where tch_id=? and tch_status=1";
		Connection conn = null;
	...
	public Teacher userInfo(String tch_id) throws SQLException {
		Teacher teacher = new Teacher();
		String sql = "select tchno, name from teacher where tch_id=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public int delete(String tch_id) throws SQLException {
		int result = 0;
		String sql = "update teacher set tch_status=0 where tch_id=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
