...
//		String sql = "select count(*) from classe where keyword like ? or class_name like ?";
		String sql = "select count(*) from classe c, teacher t where c.tchno = t.tchno and (c.keyword like ? or c.class_name like ? or t.name like ?) and c.status=0";
		try {
			conn = getConnection();
	...
	public List<Classe> classList(String sword) throws SQLException {
...
//		String sql = "select * from classe where keyword like ? or class_name like ?";
		String sql = "select * from classe c, teacher t where c.tchno = t.tchno and (c.keyword like ? or c.class_name like ? or t.name like ?) and c.status=0";				
